...
"background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:1, stop:0 rgba(38, 167, 146, 255), stop:1 rgba(255, 255, 255, 255));}")
        ...
        self.btn_save.setGeometry(QRect(600, 450, 91, 24))
        self.btn_new_prod = QPushButton(self.centralwidget)
        self.btn_new_prod.setObjectName(u"btn_new_prod")
        self.btn_new_prod.setGeometry(QRect(80, 450, 121, 24))
        ...
        self.btn_new_tool = QPushButton(self.centralwidget)
        self.btn_new_tool.setObjectName(u"btn_new_tool")
        self.btn_new_tool.setGeometry(QRect(210, 450, 121, 24))
        ...
        self.btn_new_prog = QPushButton(self.centralwidget)
        self.btn_new_prog.setObjectName(u"btn_new_prog")
        self.btn_new_prog.setGeometry(QRect(340, 450, 131, 24))
        self.line = QFrame(self.centralwidget)
        self.line.setObjectName(u"line")
        self.line.setGeometry(QRect(470, 450, 20, 20))
        self.line.setFrameShape(QFrame.VLine)
        self.line.setFrameShadow(QFrame.Sunken)
        self.btn_delete = QPushButton(self.centralwidget)
        self.btn_delete.setObjectName(u"btn_delete")
        self.btn_delete.setGeometry(QRect(490, 450, 101, 24))
        self.btn_close = QPushButton(self.centralwidget)
        self.btn_close.setObjectName(u"btn_close")
        self.btn_close.setGeometry(QRect(700, 450, 91, 24))
        self.line_2 = QFrame(self.centralwidget)
        self.line_2.setObjectName(u"line_2")
        self.line_2.setGeometry(QRect(10, 430, 781, 20))
    ...
    def retranslateUi(self, SettingWindow):
        ...
        self.btn_new_prod.setText(QCoreApplication.translate("SettingWindow", u"Neues Produkt", None))
        ...
        self.btn_new_tool.setText(QCoreApplication.translate("SettingWindow", u"Neuer Einsatz", None))
        ...
        self.btn_new_prog.setText(QCoreApplication.translate("SettingWindow", u"Neues Programm", None))
        self.btn_delete.setText(QCoreApplication.translate("SettingWindow", u"Zeile l\u00f6schen", None))
